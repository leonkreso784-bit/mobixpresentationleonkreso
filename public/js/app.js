...
class MobixPresentation {
    ...
    generateExtendedContent(type, title, desc) {
        ...
        const detailedContent = {
            ...
            // ========== SLIDE 14: Revenue Potential (100K Monthly Users) ==========
            'Subscriptions': 'At 100K monthly active users: 58% Free, 30% Plus (30,000 × €9.99 = €299,700), 12% Premium (12,000 × €17.99 = €215,880). Total subscription revenue: €515,580 per month. Subscriptions stabilize cash flow and fund AI infrastructure costs.',
            
            'Booking Commissions': 'From 42,000 paid users, 28% make bookings = 11,760 bookings/month. Average booking value: €520. Blended commission rate: 10.5% (hotels 12-18%, flights 3-6%, experiences 10-20%). Monthly commission revenue: €642,096. This is the largest revenue stream.',
            
            'B2B Solutions': '80 partner agencies/hotels on subscription plans (80 × €1,500/month = €120,000) plus sponsored recommendation campaigns (€60,000/month) = €180,000/month B2B revenue. High-margin enterprise revenue grows as platform scales.',
